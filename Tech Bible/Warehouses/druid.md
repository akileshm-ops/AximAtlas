---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 30.0.0 verified)",
...
# Apache Druid Technology Profile

![Apache Druid Logo](https://upload.wikimedia.org/wikipedia/commons/5/5e/Apache_Druid_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 30.0.0 verified)
