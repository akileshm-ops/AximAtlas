---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 1.2.0 verified)",
...
# Apache Pinot Technology Profile

![Apache Pinot Logo](https://upload.wikimedia.org/wikipedia/commons/8/87/Apache_Pinot_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 1.2.0 verified)
