---
{
  "identity": {
    "name": "Apache Iceberg",
    "vendor": "Apache / Linux Foundation",
    "licensing": "Apache 2.0 / Proprietary",
    "categorySubcategory": "Warehouses / Lakehouses",
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 1.6.0 verified)",
...
# Apache Iceberg Technology Profile

![Apache Iceberg Logo](https://upload.wikimedia.org/wikipedia/commons/8/83/Apache_Iceberg_Logo.svg)

## Identity
- **Name**: Apache Iceberg
- **Vendor**: Apache / Linux Foundation
- **Licensing**: Apache 2.0 / Proprietary
- **Category & subcategory**: Warehouses / Lakehouses
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 1.6.0 verified)
