---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 0.16.0 verified)",
...
# Apache Hudi Technology Profile

![Apache Hudi Logo](https://upload.wikimedia.org/wikipedia/commons/1/1a/Apache_Hudi_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 0.16.0 verified)
