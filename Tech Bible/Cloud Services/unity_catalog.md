---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 0.2.0 verified)",
...
# Unity Catalog Technology Profile

![Unity Catalog Logo](https://upload.wikimedia.org/wikipedia/commons/3/36/Unity_Catalog_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 0.2.0 verified)
