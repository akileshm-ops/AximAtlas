---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 1.16.0 verified)",
...
# OpenLineage Technology Profile

![OpenLineage Logo](https://upload.wikimedia.org/wikipedia/commons/1/13/OpenLineage_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 1.16.0 verified)
