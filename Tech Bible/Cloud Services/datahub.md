---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 0.14.0 verified)",
...
# DataHub Technology Profile

![DataHub Logo](https://upload.wikimedia.org/wikipedia/commons/c/ca/DataHub_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 0.14.0 verified)
