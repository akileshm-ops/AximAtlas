---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 4.1.0 verified)",
...
# Apache Superset Technology Profile

![Apache Superset Logo](https://upload.wikimedia.org/wikipedia/commons/0/07/Apache_Superset_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 4.1.0 verified)
