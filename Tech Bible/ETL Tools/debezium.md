---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 2.7.0 verified)",
...
# Debezium Technology Profile

![Debezium Logo](https://upload.wikimedia.org/wikipedia/commons/0/07/Debezium_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 2.7.0 verified)
