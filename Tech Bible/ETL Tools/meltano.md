---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 3.5.0 verified)",
...
# Meltano Technology Profile

![Meltano Logo](https://upload.wikimedia.org/wikipedia/commons/e/ea/Meltano_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 3.5.0 verified)
