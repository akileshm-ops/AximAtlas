---
{
  "identity": {
    "name": "Temporal",
    "vendor": "Orchestration Vendors",
    "licensing": "Apache 2.0 / MIT",
    "categorySubcategory": "ETL Tools / Orchestration",
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 1.25.0 verified)",
...
# Temporal Technology Profile

![Temporal Logo](https://upload.wikimedia.org/wikipedia/commons/d/d4/Temporal_Logo.svg)

## Identity
- **Name**: Temporal
- **Vendor**: Orchestration Vendors
- **Licensing**: Apache 2.0 / MIT
- **Category & subcategory**: ETL Tools / Orchestration
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 1.25.0 verified)
