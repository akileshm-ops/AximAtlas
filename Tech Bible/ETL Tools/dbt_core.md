---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 1.9.0 verified)",
...
# dbt Core Technology Profile

![dbt Core Logo](https://raw.githubusercontent.com/devicons/devicon/master/icons/dbt/dbt-original.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 1.9.0 verified)
