---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 1.8.0 verified)",
...
# Dagster Technology Profile

![Dagster Logo](https://upload.wikimedia.org/wikipedia/commons/2/23/Dagster_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 1.8.0 verified)
