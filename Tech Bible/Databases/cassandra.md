---
{
  "identity": {
    ...
    "vendor": "MongoDB / Apache / Neo4j",
    "licensing": "Various Licenses",
    "categorySubcategory": "Databases / NoSQL",
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 5.0.0 verified)",
...
# Apache Cassandra Technology Profile

![Apache Cassandra Logo](https://raw.githubusercontent.com/devicons/devicon/master/icons/apachecassandra/apachecassandra-original.svg)

## Identity
- **Name**: Apache Cassandra
- **Vendor**: MongoDB / Apache / Neo4j
- **Licensing**: Various Licenses
- **Category & subcategory**: Databases / NoSQL
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 5.0.0 verified)
