---
{
  "identity": {
    ...
    "categorySubcategory": "Databases / OLTP",
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 2022 verified)",
...
# Microsoft SQL Server Technology Profile

![Microsoft SQL Server Logo](https://raw.githubusercontent.com/devicons/devicon/master/icons/microsoftsqlserver/microsoftsqlserver-original.svg)

## Identity
- **Name**: Microsoft SQL Server
- **Vendor**: Various Vendors
- **Licensing**: Open Source / Commercial
- **Category & subcategory**: Databases / OLTP
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 2022 verified)
