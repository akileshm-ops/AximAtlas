---
{
  "identity": {
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 1.20.0 verified)",
...
# Apache Flink Technology Profile

![Apache Flink Logo](https://upload.wikimedia.org/wikipedia/commons/e/e0/Apache_Flink_Logo.svg)
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 1.20.0 verified)
