---
{
  "identity": {
    "name": "Apache Spark",
    "vendor": "Apache / CNCF / Various",
    "licensing": "Apache 2.0 / BSL / Proprietary",
    "categorySubcategory": "Streaming Systems / Messaging",
    ...
    "ecosystemMaturity": "Mature enterprise standard (Stable Version 3.5.2 verified)",
...
# Apache Spark Technology Profile

![Apache Spark Logo](https://raw.githubusercontent.com/devicons/devicon/master/icons/apachespark/apachespark-original.svg)

## Identity
- **Name**: Apache Spark
- **Vendor**: Apache / CNCF / Various
- **Licensing**: Apache 2.0 / BSL / Proprietary
- **Category & subcategory**: Streaming Systems / Messaging
...
## Ecosystem maturity
- **Value**: Mature enterprise standard (Stable Version 3.5.2 verified)
